    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nonce_str', models.CharField(blank=True, max_length=50, null=True, verbose_name='')),
                ('trade_no', models.CharField(blank=True, max_length=100, null=True, unique=True, verbose_name='')),
